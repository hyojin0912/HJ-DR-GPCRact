...
DR_COORD_PATH = f"../data/Final_GPCR_all_DR_labels_{DISP_THRESHOLD_AGO}_{DISP_THRESHOLD_ANT}_{DISP_THRESHOLD_STATE}.pt"
DR_SETS_PATH = f"../data/GPCR_DR_sets_thr_{DISP_THRESHOLD_AGO}_{DISP_THRESHOLD_ANT}_{DISP_THRESHOLD_STATE}.csv"
